...
public class MlriskscorelmFactory implements KiePMMLModelFactory {

    private static final List<KiePMMLModel> KIE_PMML_MODELS = Arrays.asList(new mlriskscorelm.LmModel());
