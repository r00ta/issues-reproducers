 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__FFD84B6F_459604_454B1A_458AC6_45A53554FC9B8D;
...
@Path("/myMortgage")
public class MyMortgageResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_FFD84B6F-9604-4B1A-8AC6-A53554FC9B8D", "myMortgage");
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_FFD84B6F-9604-4B1A-8AC6-A53554FC9B8D", "myMortgage", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("myMortgage") + ".dmn_nologic")));
    }
